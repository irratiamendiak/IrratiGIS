...
function classify(firms,context={}){
 ...
 const industrialTag=context.industrialTag===true;
 ...
 const nearIndustrial=nearestIndustrial!=null&&nearestIndustrial<=180;
 ...
 else if(industrialTag&&nearIndustrial){score-=12;reasons.push("instalación industrial muy próxima al foco")}
 ...
 else if(industrialTag&&(urban||veryNearIndustrial))category="probable_industrial_source";
 ...
 return{category,label:labels[category],score,reasons,confidence,frp,nearestIndustrialMeters:industrialTag?nearestIndustrial:null,repeatedDetections:repeated,temporalRepeatedDetections:temporalRepeated}
}
