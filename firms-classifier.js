...
function classify(firms,context={}){
 ...
 const urban=Boolean(context.urban)||hasTag(context,URBAN_TAGS)||industrialTag;
 ...
 const interfaceForest=nearestForest!=null&&nearestForest<=500&&(!urban||nearestForest<=300);
 ...
 else if(urban&&(industrialTag||veryNearIndustrial))category="probable_industrial_source";
