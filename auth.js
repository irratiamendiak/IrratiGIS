(()=>{
  ...
  function installFirmsLeafletOverlay(){
    const leafletMap=window.IrratiGISMap||((typeof map!=="undefined")?map:null);
    if(!leafletMap||typeof L==="undefined")return false;
    if(!window.IrratiGISFirmsLayer)window.IrratiGISFirmsLayer=L.featureGroup();
  ...
  function setupAppArchitecture(){
    ...
    if(originalMapHead){const h2=originalMapHead.querySelector("h2");if(h2)h2.textContent="Suteen eta erreketa baimenduen ikustailea";const badges=originalMapHead.querySelector("div div");if(badges)badges.innerHTML="";}
